# 📱 安卓手机音乐
## 📥 资源下载
#### **软件下载（夸克网盘）**：[点击跳转保存](https://pan.quark.cn/s/537d14d29281)

## 🎵 特别推荐：
### 1. 音悦
> #### 全网音乐：可绑定网易云、QQ音悦、导入酷狗、酷我歌单
### 2. 云音Music
> #### 全网音乐
### 3. 酷我音乐绿化版 聆听会员音乐
* 手机
...
#### 使用方法：`左上角菜单`-`插件设置`-`从网络导入`-`填入链接`
---
### 洛雪音乐LX Music
使用方法：`设置`-`基本设置`-`拉到最下方`-`自定义源管理`-`导入`-`在线导入`-`填入链接`

#### 插件接口链接：
* **Huibg Ixmusic源：**`https://fastly.jsdelivr.net/gh/Huibq/keep-alive/render_api.js`
* **野花：**`https://fastly.jsdelivr.net/gh/Huibq/keep-alive/Music_Free/myPlugins.json`
